    ...
    <div className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="section-container relative z-10 pt-24 pb-16 w-full">
        <div className="max-w-4xl">
          {/* Eyebrow */}
          <div className="inline-flex items-center space-x-2 px-4 py-2 bg-carbon/90 backdrop-blur-md border border-white/20 rounded-full mb-6">
            <div className="w-1.5 h-1.5 bg-cyan rounded-full"></div>
            <span className="text-xs md:text-sm text-ivory font-medium uppercase tracking-widest">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-[1.1] tracking-tight mb-6">
            ...
            <span className="block text-ivory mt-2">
              Predict What <span className="text-cyan">Comes Next</span>.
            </span>
          </h1>

          {/* Supporting Text */}
          <p className="text-lg md:text-xl text-ivory-secondary leading-relaxed max-w-3xl mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button 
              ...
              className="group px-8 py-4 bg-cyan hover:bg-cyan-light text-carbon font-semibold rounded-lg transition-all duration-200 text-lg shadow-lg"
            >
              View Forecasts
            </button>
            <button 
              onClick={() => onExplore('intelligence')}
              className="px-8 py-4 bg-transparent hover:bg-carbon-surface text-ivory font-semibold rounded-lg border border-white/28 hover:border-white/40 transition-all duration-200 text-lg"
            >
